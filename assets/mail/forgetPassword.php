...
$mail->Subject = '=?UTF-8?B?' . base64_encode("🔐 Votre nouveau mot de passe est prêt !") . '?='; 
    ...
    <center>
        <table width="100%" cellspacing="0" cellpadding="0">
            <tbody>
                ...
                <tr>
                    <td id="title">R&eacute;initialisation de votre mot de passe</td>
                </tr>
                <tr>
                    <td>
                        <p>Bonjour,</p>
                        <p>Sous le bouton “Se connecter” est inscrit votre nouveau mot de passe. L’&eacute;quipe <span id="redBold">Do It 4 Vend&eacute;e</span> vous souhaite un bon shopping !</p>
                    </td>
                </tr>
                <tr>
                    <td id="linkButtonContainer">
                       <a id="linkButton" href="https://doit4vendee.fr/login">Se connecter</a>
                    </td>
                </tr>
                <tr>
                    <td id="idCommande">Votre nouveau mot de passe</td>
                </tr>
                <tr>
                    <td id="newPassword"><?=$newPass?></td>
                </tr>
                <tr>
                    <td class="container" id="faq">En cas de dysfonctionnement du nouveau mot de passe g&eacute;n&eacute;r&eacute;, contactez-nous par e-mail (<a href="mailto:contact@doit4vendee.fr" target="_blank" x-apple-data-detectors="true"><font color="#9C9C9C">contact@doit4vendee.fr</font></a>) ou au +33 7 63 73 84 87.</td>
                </tr>
                <tr>
                    <td id="svgContainer">
