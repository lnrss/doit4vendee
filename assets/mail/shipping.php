...
$mail->Subject = '=?UTF-8?B?' . base64_encode("🚀 Votre commande prend son envol !") . '?='; 
    ...
    <center>
        <table width="100%" cellspacing="0" cellpadding="0">
            <tbody>
                ...
                <tr>
                    <td id="title">Votre commande prend son envol !</td>
                </tr>
                <tr>
                    <td>
                        <p>Bonjour <?=$_POST['firstName']?>,</p>
                        <p>Tel un oiseau quitte son nid, votre commande s’envole à votre domicile ! Plus que quelques jours de patience..</p>
                    </td>
                </tr>
                <tr>
                    <td id="linkButtonContainer">
                       <a id="linkButton" href="https://doit4vendee.fr/login">Suivre mon colis</a>
                    </td>
                </tr>
                <tr>
                    <td id="idCommande">Votre num&eacute;ro de commande #<?=$_POST['orderId']?></td>
                </tr>
                <tr>
                    <td id="dateOrder">Expédié le <?=date('d M. Y', strtotime($_POST['dateShipping']))?></td>
                </tr>
                <tr>
