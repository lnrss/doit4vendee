...
$mail->addAddress('contact@doit4vendee.fr');
$mail->addAddress('nourrisson.leo@gmail.com');

$mail->Subject = '=?UTF-8?B?' . base64_encode("📦 Nouvelle commande #".$orderId."") . '?='; 
    ...
    <center>
        <table width="100%" cellspacing="0" cellpadding="0">
            <tbody>
                ...
                <tr>
                    <td id="title">Nouvelle commande</td>
                </tr>
                <tr>
                    <td>
                        <p>
                            ...
                            Prénom: <?=$lastName?> <br/>
                            Email: <?=$email?> <br/>
                            ID Commande #<?=$orderId?> <br/>
                            Facture n°<?=$idInvoice?> <br/>
                            Commandé le <?=date('d M. Y', strtotime($dateOrder))?> <br/>
                            Total: <?=$price?>€ <br/>
                        </p>
                    </td>
                </tr>
                <tr>
                    <td id="linkButtonContainer">
                       <a id="linkButton" href="https://doit4vendee.fr/login">Faire son dossier</a>
                    </td>
                </tr>
                <tr>
                    <td id="svgContainer">
