...
try{
    if (file_exists('assets/invoice/'.$idClient)) {
        $mail->AddAttachment('assets/invoice/'.$idClient.'/FAC-'.$idInvoice.'.pdf');
    }
}catch(Exception $e){}
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <p>Votre commande a bien &eacute;t&eacute; reçue ! Toute l’&eacute;quipe <span id="redBold">Do It 4 Vend&eacute;e </span>est ravis de prendre en charge votre commande.</p>
                    </td>
                </tr>
                <tr>
                    <td id="linkButtonContainer">
                       <a id="linkButton" href="https://doit4vendee.fr/login">Mon espace client</a>
                    </td>
                </tr>
                <tr>
                    <td id="idCommande">Votre num&eacute;ro de commande #<?=$orderId?></td>
                </tr>
                <tr>
                    <td id="dateOrder">Commandé le <?=date('d M. Y', strtotime($dateOrder))?></td>
                </tr>
                <tr>
